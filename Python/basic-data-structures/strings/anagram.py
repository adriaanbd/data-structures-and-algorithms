"""
Anagrams
An anagram is a word (or phrase) that is formed by rearranging
...
Your function should take two strings as input and return True
if the two words are anagrams and False if they are not.
